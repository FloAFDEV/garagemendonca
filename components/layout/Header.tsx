			...
			<Container as="nav" aria-label="Navigation principale">
				<div className="flex items-center justify-between h-16 md:h-[72px]">
					...
					<Link
						...
						aria-label="Garage Mendonça – Accueil"
					>
				...
				{isOpen && (
					<>
						...
						<div className="fixed top-16 left-0 right-0 z-50 px-4">
							<div className="bg-white rounded-2xl p-4 flex flex-col gap-1 border border-slate-200 shadow-lg animate-slide-down">
								{navLinks.map((link) => (
									<Link
										key={link.href}
										href={link.href}
