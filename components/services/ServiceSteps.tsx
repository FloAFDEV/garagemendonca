			...
			>
				...
				<div className="relative flex items-start">
					...
					{sorted.map((step) => (
						...
						>
							{/* Cercle numéroté */}
							<div className="w-10 h-10 rounded-full bg-brand-500 text-white flex items-center justify-center text-sm font-medium flex-shrink-0 z-10 shadow-sm shadow-brand-500/30">
								{step.order}
							</div>
				...
				{sorted.map((step, i) => (
					<div key={step.order} className="flex gap-4">
						...
						<div className="flex flex-col items-center flex-shrink-0">
							<div className="w-9 h-9 rounded-full bg-brand-500 text-white flex items-center justify-center text-sm font-medium shadow-sm shadow-brand-500/30">
								{step.order}
							</div>
							{i < sorted.length - 1 && (
								<div
