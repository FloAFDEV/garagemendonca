...
function StepCard({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.48, ease: [0.25, 0.46, 0.45, 0.94], delay: index * 0.08 }}
      className={`
    ...
    <section id="process" className="py-24 bg-white" aria-labelledby="process-title">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="relative max-w-3xl mx-auto">
          ...
          {/* Ligne verticale centrale — visible desktop uniquement */}
          <div
            aria-hidden="true"
            className="
              hidden sm:block
              ...
              return (
                ...
                >
                  ...
                  <div className="hidden sm:block">
                    {isLeft && <StepCard step={step} index={i} side="left" />}
                  </div>

                  {/* ── Desktop : badge numéro (centre) ── */}
                  <motion.div
                    aria-hidden="true"
                  ...
                  >
                    <div
                      className="
                        ...
                        bg-white border-2 border-brand-500/30
                  ...
                  <div className="hidden sm:block">
                    {!isLeft && <StepCard step={step} index={i} side="right" />}
                  </div>
                  ...
                  <motion.div
                    ...
                    className="
                      sm:hidden flex items-center gap-4
                      bg-white rounded-2xl border border-slate-200
        ...
        >
          <div
            className="
              ...
              shadow-sm
              max-w-lg w-full text-center sm:text-left
            "
          >
            <div
              aria-hidden="true"
