...
const steps = [
	{
		...
		description:
			"Appelez le 05 32 00 20 38 ou envoyez un message. Accueil avec ou sans rendez-vous, du lundi au vendredi.",
	},
	{
		num: "02",
		Icon: ScanSearch,
		title: "Diagnostic",
		description:
			"Diagnostic en 10 minutes sur équipement dernière génération. Lecture des codes défaut OBD, toutes marques.",
	},
	{
		num: "03",
		Icon: FileText,
		...
		description:
			"Un devis pièce et main-d'œuvre détaillé est établi avant toute intervention. Aucune surprise sur la facture.",
	},
	{
		num: "04",
		Icon: Wrench,
		title: "Réparation",
		description:
			"Intervention réalisée par nos mécaniciens qualifiés. Préconisations constructeur toujours respectées.",
	},
	{
		num: "05",
		Icon: CheckCircle2,
		title: "Restitution",
		description:
			"Votre véhicule restitué propre (nettoyage intérieur/extérieur inclus) avec compte-rendu complet des travaux.",
	},
];
			...
			<Container>
				...
				<AnimateOnScroll>
					<div className="max-w-xl mb-16">
						...
						<span className="eyebrow">Comment ca se passe</span>
				...
				<div className="relative">
					...
					<div
						className="hidden lg:block absolute top-9 left-0 right-0 h-px bg-slate-200"
						aria-hidden="true"
					/>
				...
				<AnimateOnScroll delay={200}>
					<div className="mt-16 pt-12 border-t border-slate-200 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
						<p className="text-[#475569] text-sm max-w-md leading-relaxed">
							Véhicule de courtoisie disponible pendant toute
							intervention — 9 véhicules offerts ou 1 véhicule
							neuf à 16 € HT/jour.
						</p>
						<a
							href="tel:0532002038"
