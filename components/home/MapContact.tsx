    ...
    <section className="py-20 bg-dark-50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          {/* Info panel */}
          <AnimateOnScroll delay={80} className="lg:col-span-2 flex flex-col gap-6">
            {/* Address */}
            <div className="bg-white rounded-2xl p-6 border border-dark-100 shadow-card hover:shadow-card-hover transition-shadow duration-300">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-1.5 text-brand-600 text-sm font-medium mt-3 hover:text-brand-700 transition-colors focus-visible:ring-2 focus-visible:ring-brand-400 rounded"
                  >
          ...
          <AnimateOnScroll delay={160} className="lg:col-span-3">
            <div className="rounded-2xl overflow-hidden border border-dark-200 shadow-card h-full min-h-[400px]">
              <iframe
