    ...
    <MainLayout>
      <div className="pt-24 bg-[#f8fafc] min-h-screen">
        <div className="container mx-auto px-4 py-10">
          ...
          <Link
            href="/vehicules"
            className="inline-flex items-center gap-2 text-[#475569] hover:text-brand-600 transition-colors mb-8 text-sm font-medium"
          >
            <ArrowLeft size={16} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {vehicle.images.length > 1 && (
                <div className="grid grid-cols-3 gap-3">
                  {vehicle.images.slice(1).map((img, idx) => (
                    <div
                      key={idx}
                      className="relative aspect-[4/3] rounded-xl overflow-hidden bg-slate-200 cursor-pointer hover:opacity-90 transition-opacity shadow-sm"
                    >
                      <Image
                        src={img}
              ...
              <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {specs.map(({ Icon, label, value }) => (
                    <div
                      key={label}
                      className="flex items-center gap-3 bg-[#f8fafc] rounded-xl p-4"
                    >
              ...
              {/* Description */}
              <div className="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
                <h2 className="font-heading font-bold text-[#0f172a] text-2xl mb-4">
                  Description
                </h2>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 sticky top-24">
                <div className="mb-1">
                  <h1 className="font-heading font-black text-[#0f172a] text-3xl">
                    {vehicle.brand} {vehicle.model}
                  </h1>
                  <p className="text-[#64748b] mt-1">{vehicle.year} · {vehicle.color}</p>
                </div>
                ...
                <div className="py-6 border-y border-slate-200 my-6">
                  ...
                  <p className="text-[#64748b] text-sm mt-1">Prix TTC · Financement possible</p>
                </div>
          ...
          {related.length > 0 && (
            <div className="mt-16">
              <h2 className="font-heading font-bold text-[#0f172a] text-2xl mb-8">
