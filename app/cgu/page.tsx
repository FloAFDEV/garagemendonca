...
const sections = [
  {
    title: "1. Objet",
    content: `Les présentes Conditions Générales d'Utilisation (CGU) régissent l'accès et l'utilisation du site internet www.garagemendonca.com, édité par le Garage Auto Mendonça (ci-après « le Garage »).
      ...
      <section className="bg-[#f8fafc] border-b border-slate-200 pt-32 pb-12">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl">
            ...
            <h1 className="section-title mt-1">Conditions Générales d'Utilisation</h1>
