...
Les photos présentées sur le site sont non contractuelles.`,
	...
	},
	{
		...
		content: `Le présent site et les présentes mentions légales sont soumis au droit francais. En cas de litige, les tribunaux compétents seront ceux du ressort du Tribunal de Commerce de Toulouse.`,
	},
];
									...
									{content.split("\n").map((line, i) => {
										if (
											...
											return (
												<p
													key={i}
													className="font-normal text-[#0f172a]"
												>
													{line.slice(2, -2)}
												</p>
											);
