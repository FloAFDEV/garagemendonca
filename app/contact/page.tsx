        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="max-w-3xl">
            ...
            <h1 className="font-heading font-black text-white text-5xl md:text-6xl mb-6 leading-tight">
              Contactez-nous —{" "}
              <span className="text-brand-500">devis gratuit sous 24h</span>
            </h1>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="lg:col-span-2 lg:order-2 space-y-5">
              <h2 className="font-heading font-bold text-[#0f172a] text-2xl mb-6">Nos coordonnées</h2>

              {/* Téléphone */}
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                <div className="flex items-center gap-4 mb-3">
                  <div className="w-12 h-12 bg-brand-50 rounded-xl flex items-center justify-center flex-shrink-0" aria-hidden="true">
                    <Phone size={22} className="text-brand-600" aria-hidden="true" />
                  </div>
                  <div>
                    <p className="text-xs text-[#475569] font-medium">Téléphone</p>
                    <a href="tel:0532002038" className="font-heading font-bold text-[#0f172a] text-xl hover:text-brand-600 transition-colors">
                      05 32 00 20 38
                    </a>
                  </div>
                </div>
                <a href="tel:0532002038" className="btn-primary w-full justify-center mt-2">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-brand-50 rounded-xl flex items-center justify-center flex-shrink-0" aria-hidden="true">
                    <Mail size={22} className="text-brand-600" aria-hidden="true" />
                  </div>
                  <div>
                    <p className="text-xs text-[#475569] font-medium mb-1">Email</p>
                    <a href="mailto:contact@garagemendonca.com" className="font-semibold text-[#0f172a] hover:text-brand-600 transition-colors text-sm break-all">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-brand-50 rounded-xl flex items-center justify-center flex-shrink-0" aria-hidden="true">
                    <MapPin size={22} className="text-brand-600" aria-hidden="true" />
                  </div>
                  <div>
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
                ...
                <ul className="space-y-2">
                  {hours.map(({ day, time, open }) => (
                    <li key={day} className="flex items-center justify-between text-sm border-b border-slate-100 pb-2 last:border-0 last:pb-0">
                      <span className="text-[#475569]">{day}</span>
                      <span className={`font-medium ${open ? "text-[#0f172a]" : "text-red-500"}`}>{time}</span>
                    </li>
                  ))}
                </ul>
              </div>
