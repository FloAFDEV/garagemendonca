...
const recentMessages = [
  { name: "Marc Leblanc", subject: "Renseignement Peugeot 308 SW", time: "Il y a 2h" },
  { name: "Sophie Durand", subject: "Demande de devis freinage", time: "Il y a 5h" },
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
          {stats.map(({ label, value, change, icon: Icon, color, bg }) => (
            ...
            >
              ...
              <div className="text-dark-500 text-xs mt-1">{change}</div>
            </div>
          ))}
        </div>
              ...
              {recentMessages.map(({ name, subject, time }) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-dark-500 text-xs mt-0.5 truncate">{subject}</div>
                    <div className="text-dark-600 text-xs mt-1">{time}</div>
                  </div>
                </div>
              ))}
            </div>
